...
void init_ip()
{
  // NTT_INTT_IP accelerator send interrupt on ext_intr line 0
  ...
  // Set NTT_INTT_IP priority to 1 (target threshold is by default 0) to trigger an interrupt to the target (the processor)
